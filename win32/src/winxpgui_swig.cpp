/*
 * FILE : C:\pywin32-220\pywin32-220\win32\src\winxpgui_swig.cpp
 *
...
#endif // NEED_SWIG_PTR
#define SWIG_init    initwinxpgui

#define SWIG_name    "winxpgui"
...
static PyObject *_wrap_GetWindowRgnBox(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    int_regiontype  _result;
    HWND  _arg0;
    RECT * _arg1;
    ...
    self = self;
{
  _arg1 = &rect_output;
    ...
    if(!PyArg_ParseTuple(args,"O:GetWindowRgnBox",&_obj0))
        return NULL;
{
	if (!PyWinObject_AsHANDLE(_obj0, (HANDLE *)&_arg0))
		return NULL;
...
{
	Py_BEGIN_ALLOW_THREADS
	    _result = (int_regiontype )GetWindowRgnBox(_arg0,_arg1);

	Py_END_ALLOW_THREADS
	if (_result==ERROR){

		return PyWin_SetAPIError("GetWindowRgnBox");
		}
}    _resultobj = Py_BuildValue("i",_result);
{
    PyObject *o;
...
static PyObject *_wrap_GetConsoleWindow(PyObject *self, PyObject *args) {
    PyObject * _resultobj;
    HWND  _result;
        ...
        return NULL;
{
      Py_BEGIN_ALLOW_THREADS
      SetLastError(0);
          _result = (HWND )GetConsoleWindow();

      Py_END_ALLOW_THREADS
      DWORD le;
      if (_result==0 && (le=GetLastError())) {

           return PyWin_SetAPIError("GetConsoleWindow", le);
      }
}{
	_resultobj=PyWinLong_FromHANDLE(_result);
}
...
static PyMethodDef winxpguiMethods[] = {
	 ...
	 { "GetConsoleWindow", _wrap_GetConsoleWindow, 1 },
	 ...
	 { "GetWindowRgnBox", _wrap_GetWindowRgnBox, 1 },
...
SWIGEXPORT(void,initwinxpgui)() {
#else
#define MODINIT_ERROR_RETURN NULL
SWIGEXPORT(PyObject*,  PyInit_winxpgui)(void) {
#endif
	 PyObject *m, *d;
	 SWIG_globals = SWIG_newvarlink();
#if (PY_VERSION_HEX < 0x03000000)
	 m = Py_InitModule("winxpgui", winxpguiMethods);
	 d = PyModule_GetDict(m);
#else
  static PyModuleDef winxpgui_def = {
  ...
  m = PyModule_Create(&winxpgui_def);
  if (!m)
    return NULL;
  d = PyModule_GetDict(m);
  if (!d)
